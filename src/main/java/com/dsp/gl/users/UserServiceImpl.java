...
import com.dsp.gl.utils.TimesheetUtils;
...
public class UserServiceImpl implements UserService{
    ...
    private final static String ROLE_NAME = "EMPLOYEE";
    ...
    private DataResponse convertUserToDataResponse(Page<User> users){
        ...
        List<UserResponseDto> responses = userContents
                ...
                .toList();
        return TimesheetUtils.buildDataResponse(responses, users);
    }
    ...
    @Override
    public UserResponseDto deleteRoleUser(Long id, RoleRequestDto roleRequestDto) throws UserNotFoundException, RoleNotFoundException {
        User user = userRepository.findById(id)
    ...
    private void deleteCurrentRole(User user, String role) throws RoleNotFoundException {
