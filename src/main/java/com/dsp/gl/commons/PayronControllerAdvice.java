...
public class PayronControllerAdvice {
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ApiResponse<?> handleServiceException(TimesheetAlreadyExistException exception){
        ApiResponse<?> response = new ApiResponse<>();
        response.setErrorDTOS(Collections.singletonList(new ErrorDTO("", exception.getMessage())));
        response.setStatus(Status.ERROR);
        return response;
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ApiResponse<?> handleServiceException(TimesheetNotFoundException exception){
        ApiResponse<?> response = new ApiResponse<>();
        response.setErrorDTOS(Collections.singletonList(new ErrorDTO("", exception.getMessage())));
        response.setStatus(Status.ERROR);
        return response;
   ...
   /* @ExceptionHandler(BadCredentialsException.class)
    ...
    @ExceptionHandler(PayronNotFoundException.class)
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ApiResponse<?> handleServiceException(PayronNotFoundException exception){
        ApiResponse<?> response = new ApiResponse<>();
        response.setErrorDTOS(Collections.singletonList(new ErrorDTO("", exception.getMessage())));
        response.setStatus(Status.ERROR);
        return response;
